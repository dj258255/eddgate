...
> 실패를 분석하고, 규칙을 자동 생성하고, 다음 실행에 적용합니다. 어떤 AI 제공자에게도 데이터를 보내지 않습니다. 완전한 셀프호스팅.
...
<p align="center">
  <img src="../../assets/tui-screenshot.png" alt="eddgate TUI 스크린샷" width="720">
</p>
...
<p align="center">
  <img src="diagrams/self-improving-loop.svg" alt="자가 개선 루프" width="440">
</p>

eddgate는 루프를 닫습니다: 실패 분석이 실행 개선으로 직접 이어집니다. 하나의 도구, 하나의 순환.
...
<p align="center">
  <img src="diagrams/validation-gates.svg" alt="검증 게이트" width="720">
</p>
...
<p align="center">
  <img src="diagrams/run-dashboard.svg" alt="실행 대시보드" width="720">
</p>
...
<p align="center">
  <img src="diagrams/prompt-approval.svg" alt="프롬프트 승인 화면" width="520">
</p>
